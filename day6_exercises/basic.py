...
# ============================================
class BadEmployee:
    """Violates SRP - handles salary, file I/O, and email all in one class"""
...
# Class 1: Handles employee data only
class Employee:
    """Responsibility: Manage employee data"""
...
# Class 2: Handles salary calculations only
class SalaryCalculator:
    """Responsibility: Calculate salary-related values"""
...
# Class 3: Handles file operations only
class EmployeeFileManager:
    """Responsibility: Save employee data to files"""
...
# Class 4: Handles email notifications only
class EmailNotifier:
...
# ============================================
# BAD DESIGN: Uses if-elif (Violates OCP)
# ============================================
print("\n--- Bad Design (Violates OCP) ---")

def calculate_bonus_bad(employee_type, salary):
    """Violates OCP - must modify this function for new employee types"""
...
class EmployeeType:
    """Abstract base class for employee types"""
...
class SeniorDeveloper(EmployeeType):
    """New employee type added without modifying existing code!"""
    def get_bonus_percentage(self):
        return 0.25

# Clean function that follows OCP
def calculate_bonus(employee_type, salary):
    """Works with any EmployeeType subclass - follows OCP"""
...
def make_bird_fly(bird):
    """This function breaks when given a Penguin!"""
    bird.fly()
...
def make_bird_fly_lsp(bird):
    """Only works with FlyingBird subclasses - LSP safe!"""
