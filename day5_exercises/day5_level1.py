# ============================================
# Day 5 - Level 1: Basic Inheritance
# ============================================
...
class Car(Vehicle):
    ...
    def __init__(self, name, model, year, doors):
        """Constructor with additional doors attribute"""
...
class Motorcycle(Vehicle):
    ...
    def __init__(self, name, model, year, type):
        """Constructor with additional type attribute"""
...
# First, let's create a base Account class (from Day 4)
class Account:
    """Base Account class"""
...
class SavingsAccount(Account):
    ...
    def __init__(self, owner, account_number, balance=0, interest_rate=0.05):
        """Constructor with additional interest rate"""
...
class CurrentAccount(Account):
    ...
    def __init__(self, owner, account_number, balance=0, overdraft_limit=500):
        """Constructor with additional overdraft limit"""
        super().__init__(owner, account_number, balance)
